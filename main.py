...
from basic_pipelines.detection_pipeline import app_callback_class, dummy_callback
...
if __name__ == "__main__":
    ...
    gstreamer_proc = multiprocessing.Process(target=lambda: GStreamerDetectionApp(dummy_callback, app_callback_class(), bbox_queue).run())
